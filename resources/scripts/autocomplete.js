...
function AddressValidator(value, element, paras) {
    ...
    geocoder.geocode({ 'address': CurrentAddress }, function (results, status) {
        ...
        if (status === google.maps.GeocoderStatus.OK) {
            ...
            /* Count the commas in the formatted address. This doesn't look great, but it helps us understand how specific the geocoded address is.  For example, "CA" will geocde to "California, USA". */
